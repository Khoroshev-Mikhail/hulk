    ...
    return(
        <section id="06Roadmap" className="_section relative mt-32">
            <div className="_wrapper relative">
                ...
                <div className="hidden md:block absolute w-full h-3/4 -z-50 top-[15%] left-1/2 transform -translate-x-1/2 mx-auto  bg-[url('/img/bg.png')] bg-center bg-contain bg-no-repeat bg-opacity-50"></div>
                <div className="md:hidden absolute w-full h-1/3 -z-50 top-[5%] left-1/2 transform -translate-x-1/2 mx-auto  bg-[url('/img/bg.png')] bg-center bg-contain bg-no-repeat bg-opacity-50"></div>
                <div className="md:hidden absolute w-full h-1/3 -z-50 bottom-[5%] left-1/2 transform -translate-x-1/2 mx-auto  bg-[url('/img/bg.png')] bg-center bg-contain bg-no-repeat bg-opacity-50"></div>
                <div className="md:hidden absolute w-full h-2/3 -z-50 -bottom-[5%] left-0 bg-[url('/img/eclipse_mobile.png')] bg-left bg-contain bg-no-repeat "></div>
                <div className="md:hidden absolute w-full h-2/3 -z-50 -top-[15%] right-0 scale-x-[-1] bg-[url('/img/eclipse_mobile.png')] bg-left bg-contain bg-no-repeat "></div>
                ...
                <div className="px-5 mt-12 md:mt-24 relative grid grid-cols-6 grid-rows-4 md:grid-cols-4 md:grid-rows-none [&>div>ul]:list-image-[url(/img/06Roadmap/romb.svg)] [&>div>ul>li]:pl-3">
                    ...
                    <div className="-ml-2.5 md:ml-0 col-span-1 col-start-1 row-span-4 md:row-span-1 grid grid-cols-1 grid-rows-4 md:grid-rows-1 md:grid-cols-4 md:my-8 md:row-start-2 md:col-span-4 md:w-full border-[1px] border-_green w-1 md:h-1">
                        <div className="row-span-1 rounded-full border-[1px] border-_green h-10 w-10 -ml-5 md:-ml-1 -mt-1 md:-mt-5 bg-_black flex md:flex-col justify-center">
                            <div className="bg-_black md:h-[2px] h-[120%] ml-[2px] w-[2px] md:mt-[2px] md:w-[120%] md:-mr-1 "></div>
                        </div>
                        <div className="row-span-1 rounded-full border-[1px] border-_green h-10 w-10 -ml-5 md:-ml-0 -mt-1 md:-mt-5 bg-_black flex md:flex-col justify-center">
                    ...
                    <div className="pb-14 md:pb-0 col-span-5 md:col-start-1 md:col-end-3 md:row-start-1 relative">
                        <div>
