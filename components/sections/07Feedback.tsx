        ...
        <section id="07Feedback" className="_section pt-10 sm:pt-14 md:pt-20 overflow-hidden">
            ...
            <div className="mt-[30px] md:mt-[60px] flex flex-col bg-_green rounded-[20px] !mx-5 max-w-[1200px] xl:!mx-auto relative">
                ...
                <div className="flex flex-col">
                    ...
                    <form className="relative z-50 p-5 flex flex-col md:flex-row mt-[24px] md:mt-[30px] gap-2.5" onSubmit={sendForm}>
                ...
                <div className="w-full relative pt-[6%]">
                    <Image src={hulk} alt="HULK" className="w-full relative z-50"/>

                    <div className="w-4/5 h-full absolute z-10 bottom-0 left-1/2 -translate-x-1/2 transform  bg-[url('/img/bg.png')] bg-cover bg-top-center">
