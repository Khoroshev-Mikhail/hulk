                ...
                <div className="w-full max-w-[1200px] mx-auto relative flex flex-col justify-between">
                    ...
                    <div className="mt-8 w-full pb-16 md:pb-[5%] md:px-[5%]">
                        <div className="relative z-20 w-auto h-auto">
                            ...
                            <Image data-aos="zoom-in" data-aos-duration="1500" src={coin_1} alt="Mem-Coin" className="_animate-scale w-[15%] absolute -bottom-[1%] md:-bottom-[6%] left-[2%] md:left-[8%] z-20"/>
                            <Image data-aos="zoom-in" data-aos-duration="1500" src={coin_2} alt="Mem-Coin" className="_animate-scale w-[15%] absolute -bottom-[1%] md:-bottom-[6%] left-[12%] md:left-[18%] z-20" />
                            ...
                            <a href="https://pancakeswap.finance/swap?inputCurrency=0x57a6d8E214C0CAb9FF3fB5d38F940f52026BbD64&outputCurrency=BNB" className="w-[95%] block text-center md:w-auto absolute uppercase bg-_green -bottom-14 md:bottom-[1%] font-extrabold text-black py-5 px-10 xl:py-7 xl:px-20 rounded-[20px] left-1/2 md:left-[51%] _text-14-20 z-0 md:z-50 transform -translate-x-1/2 ">Buy now</a>
                        </div>
